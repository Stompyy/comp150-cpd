...
I have had some experience of arrays in c# so the leap to using lists in python was reasonably straightforward. I had not encountered or found the need to explore other data structures, so I found it interesting to explore these other methods like dictionarys and sets, both for my own satisfaction and the promise of higher sophistication marks once incorporated into my projects. For instance in the comp110 worksheet, where the aim was to create a noughts and crosses replica, I used a dictionary structure for the board as opposed to a list of lists which would have been my initial choice. I really enjoyed the worksheet as I was quite proud of my solution which addressed the extra criteria of a n * n board, differing win lengths, and more importantly did not uncannily resemble the first solution posted on github... I was surprised at the extent with which some of the other solutions were obviously researched from the same paper, given unused class fields and identical, sometimes unnecessary, variables. It seems strange that some did not work through the challenge but then again maybe they found it too difficult? I would have thought that everyone would have given it a try especially given the generous marking criteria for a pass, and that it really wasn't difficult at all. I joked to the original author I was offended that no one copied me.

## Week eight

Code review week! It is a strange process... I have already found myself in the apparently typical programming mindset of never being happy that a project is completely finished. To be convinced that an additional feature or a better method is just one more hour of screen staring away. The strange part of the process is to see a code reviw note next to a section that you had previously believed fine. That the part to be improved was somewhere else entirely! This is brilliant though. It really feels like learning when you are not only being taught new things you are able to do, but also better ways to do the things you are already doing! This also opens up the chances to fill in gaps in your knowledge. Doc strings for example which I had seen before but had not been introduced to (I just thought the author was commenting their code in an inconsistent way), I understand now are a standard and have rigidly adhered to as part of my process, rather than the after thoughts for coherence that regular comments often are.
Thinking back to last weeks data structures I find myself facing an odd predicament. It has been made evident that incorporating a dictionary structure into a control scheme will gain marks for sophistication, however by it's nature it does not execute two controls at the same time. As I write this I think I have just figured it out... The current method will execute the first control then move on but if it would loop for the amount of times that on a full event check a relevent key returned '1'. then multiple movement fuctions could be called and the summaritive adjustments stacked in one frame. Will have to look into this - sorry probably not cpd relevant. My predicament was however what would I choose to do faced with the choice of a highly sophisticated method rife with bugs each requiring sophistication to ammend, vs a simple method using nested if statements despite having to be in the main game loop that frankly just works easily and first time. I think I would always choose the sophisticated method because of learning, pride, the challenge, and showing off, but is this correct when I know of an effective easy solution that works otherwise?

## Week nine

Deadlines are starting to loom a little more readily now with one assignment already handed in and a number more due in the next few weeks. Whilst I don't believe that I suffer from poor time management, there is certainly more pressure now than ever before to manage priorities. Whilst I would greatly enjoy going back through the com110 worksheets to perfect them I have to accept that my research journal is lacking and my progress with the agile essay is significantly worse. Luckily with some foresight I have some free time approaching with which I can bring any work that has fallen behind back up to date. I don't believe I have been misguided in my intentions so far, The Curator for instance is the largest project that we have encountered as of yet and it is very important to me that there is a continuous work flow with it not just because of its size but also that others in the team may be dependant on my progress with it, hopefully at times even spurred on by it. Meanwhile I am not certain why I am putting off the Agile essay, perhaps it is because it has been such a long time since I have written an essay, or maybe I am a little too confident in my own writing. I suppose I will find out later this week and moreso after the initial draft feedback.
